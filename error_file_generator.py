...
class ModelWeightsFeatures():
    ...
    def get_model(self):
        ...
        model.load_state_dict(torch.load("./model_weights/" + self.filepath))
        return model
...
if __name__=="__main__":
    my_f = Filepaths(keyword="pinn", dir_path="./model_weights/")
    ...
    df.to_csv("./error_data/pinn_error_data.csv")
